...
/* Définit un message d’erreur lisible selon la réponse de l’API */
...
/* Augmente la quantité du livre dans le panier */
...
/* Diminue la quantité ou retire l’article si la quantité atteint 0 */
